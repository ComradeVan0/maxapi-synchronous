...
def test_message_created_without_message_is_skipped(caplog):
    ...
    result = process_update_request(data, bot)
...
def test_known_update_type_with_missing_fields_is_skipped(caplog):
...
def test_unknown_update_type_logged_as_unknown(caplog):
